...
use commands::{add_skill_args, bundle_add_args, bundle_remove_args};
...
mod tests {
    use super::{
        bundle_provenance_choices_from_value, config_path_for_scope, default_agent_indexes,
        merge_agent_options, validate_include_pattern, wizard_intents, write_default_agents_config,
        BundleProvenanceChoice, ConfigScope, Intent,
    };
